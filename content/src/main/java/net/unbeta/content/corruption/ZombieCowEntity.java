...
/** A cow taken by zombie corruption. */
public class ZombieCowEntity extends CowEntity implements CorruptedAnimal {

    public ZombieCowEntity(EntityType<? extends CowEntity> type, World world) {
        super(type, world);
    }
