...
/** Unlit Unbeta Jack o'Lantern. Delegates to JackOLanternLogic. */
public class UnbetaJackOLanternBlock extends CarvedPumpkinBlock implements BlockEntityProvider {

    public UnbetaJackOLanternBlock(Settings settings) {
        super(settings);
        setDefaultState(getStateManager().getDefaultState().with(JackOLanternLogic.LIT, false));
    }
